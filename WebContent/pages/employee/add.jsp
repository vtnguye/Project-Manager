        ...
        <div class="col-sm-9">
          ...
          <form:errors id="error_id" path="id" cssStyle="color: #F00;" />
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<form:input type="name" id="name" path="fullName" cssClass="form-control"
						required="required" />
				</div>
			</div>
			<div class="form-group row">
				<label class="form-control-label col-sm-3">Ngày sinh<span
					class="required">(*)</span></label>
				<div class="col-sm-9">
			...
			<div class="form-group row">
				<label class="form-control-label col-sm-3">Số điện thoại<span
					class="required">(*)</span></label>
				<div class="col-sm-9">
					<form:input type="number" id="phone" path="phone" cssClass="form-control"
						required="required" />
				</div>
			</div>
			<div class="form-group row">
