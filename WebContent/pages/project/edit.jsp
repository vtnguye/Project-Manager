          ...
          <form:errors id="error_id" path="id" cssStyle="color: #F00;" />
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<form:input type="name" id="name" path="name"
						value="${o.name}" cssClass="form-control" required="required" />
				</div>
			</div>
			<div class="form-group row">
				<label class="form-control-label col-sm-3">Ngày bắt đầu<span
					class="required">(*)</span></label>
				<div class="col-sm-9">
					<form:input type="date" id="startDate" path="startDate"
						value="${o.startDate}" cssClass="form-control" required="required" />
				</div>
			</div>
			<div class="form-group row">
				<label class="form-control-label col-sm-3">Ngày kết thúc<span
					class="required">(*)</span></label>
				<div class="col-sm-9">
					<form:input type="date" id="endDate" path="endDate"
						value="${o.endDate}" cssClass="form-control" required="required" />
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<div class="col-sm-8 col-sm-offset-1">
					...
					<button type="button" onclick="location.href='${pageContext.request.contextPath}/pages/project/list.html'" class="btn btn-default">Hủy</button>
				</div>
			</div>
			<!-- hidden field -->
